...
namespace Hentu.Common.NPOI
{
    public class NPOIHelper
    {
        ...
        public static void ExportByWeb(DataTable dtSource, string strHeaderText, string strFileName)
        {
            ...
            using (var mem = Export(dtSource, strHeaderText))
            {
                curContext.Response.BinaryWrite(mem.GetBuffer());
            }
        ...
        /// <returns></returns>
        public static List<string> ExcelToList(string filePath)
        {
            ...
            try
            {
                ...
                if (sheet != null)
                {
                    ...
                    //最后一列的标号
                    for (int index = startRow; index <= sheet.LastRowNum; ++index)
                    {
